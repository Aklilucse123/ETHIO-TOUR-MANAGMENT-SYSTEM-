...
<html>
<head>
<title>ETMS | TOUR SITE DETAILS</title>
...
<div class="banner-3">
	<div class="container">
		<h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;"> ETMS - SITE Details</h1>
	</div>
</div>
<!--- /banner ---->
<!--- selectroom ---->
...
<form name="book" method="post">
		<div class="selectroom_top">
			...
			<div class="col-md-8 selectroom_right wow fadeInRight animated" data-wow-delay=".5s">
				...
				<p><b>Tour Type :</b> <?php echo htmlentities($result->PackageType);?></p>
